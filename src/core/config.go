...
func ReadConfigFiles(filenames []string) (*Configuration, error) {
	...
	defaultPath(&config.Go.TestTool, config.Please.Location, "please_go_tool")
...
type Configuration struct {
	...
	Go struct {
		...
		TestTool  string `help:"Sets the location of the please_go_tool tool that is used to template the test main for go_test rules." var:"GO_TEST_TOOL"`
